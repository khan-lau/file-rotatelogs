...
[![GoDoc](https://godoc.org/github.com/khan-lau/file-rotatelogs?status.svg)](https://godoc.org/github.com/khan-lau/file-rotatelogs)
...
import (
  ...
  apachelog "github.com/khan-lau/apache-logformat"
  rotatelogs "github.com/khan-lau/file-rotatelogs"
)
...
```
go get github.com/khan-lau/file-rotatelogs
```
...
import(
  "log"
  "github.com/khan-lau/file-rotatelogs"
)
